...
class ConvertLength extends Component {
    constructor(props){
        super(props)
        this.state = {
    ...
    calculate = () => {
        ...
        if(this.state.base==='Micrometre' && this.state.convertTo==='Foot'){
            const result = input*0.0000032808;
            this.setState({
                result
            })
        }
